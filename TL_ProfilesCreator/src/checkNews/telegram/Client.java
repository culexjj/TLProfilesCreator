...
public final class Client {
     ...
     */
    public void send(@SuppressWarnings("rawtypes") TdApi.Function query, ResultHandler resultHandler, ExceptionHandler exceptionHandler) {
    ...
    private static native void nativeClientSend(int nativeClientId, long eventId, @SuppressWarnings("rawtypes") TdApi.Function function);

    private static native int nativeClientReceive(int[] clientIds, long[] eventIds, TdApi.Object[] events, double timeout);

    private static native TdApi.Object nativeClientExecute(@SuppressWarnings("rawtypes") TdApi.Function function);

...
//
// Modified by Jose-Javier Culebras (culex.jj@gmail.com)
//
...
public final class Telegram {
    ...
    /* VARIABLES */
    private static FoundChatMessages chatMessages = new FoundChatMessages(); 
    private static FoundMessages allChatMessages = new FoundMessages(); 	
    ...
    /* METHODS */
    	...
    	//OPEN SESSION ON TELEGRAM//
    		...
    		public static void connection() throws InterruptedException {
    		    ...
    		    try {
    		        ...
    		        throw new IOError(new IOException("Folder writing rights requiered"));
    		    }
    	...
    	//SEARCH MESSAGES WHICH CONTAINS A SPECIFIC STRING ON JUST ONE CHAT//
    		 ...
    		 /**
    		  * Method for getting messages which contains the search string in one chat
    		  * @param chat (ChatId)
    		  * @param query (string to look for)
    		  * @param limit (Max Number of messages) The maximum number of messages to be returned; up to 100. For optimal performance, the number of returned messages is chosen by TDLib and can be smaller than the specified limit.
    	    ...
    	    /**
    	     * Method for getting object with all messages from a chat
    	     * @return chatMessages
    	     */    	    
    	    public static FoundChatMessages getChatMessages() {
    	    ...
    	    /**
    	     * Method for getting the total number of messages
    	     * @return
    	     */    	    
    	    public static int getNumberChatMessages() {
    	    	
    	    	return chatMessages.totalCount;
    	    }
    	    
       	    
    	    /**
    	     * Method for getting the array with the list of messages
    	     * @return
    	     */    	    
    	    public static Message[] getListofMessages() {
    	    ...
    	    /**
    	     * Method for getting the size of the array with the list of messages
    	     * @return
    	     */    	    
    	    public static int getSizeOfListofMessages() {  	 
    	    	
    	    	return chatMessages.messages.length;
    	    }
    	    
    	    
        //SEARCH MESSAGES WHICH CONTAINS A SPECIFIC STRING ON ALL CHATS//
    	    
    	    /**
    	     * Method for getting messages which contains the search string in all chats
    	     ...
    	     * @param query
    	     */
    	    public static void searchAllChatMessages(String query, int limit) {
       		   	//If your code is executing in a multi-threaded environment, you need synchronization for objects, which are shared among multiple threads, to avoid any corruption of state or any kind of unexpected behavior.
    	    	synchronized (allChatMessages) {  
    	    		client.send(new TdApi.SearchMessages(null, query, "", limit, null, 0, 0), defaultHandler);
       	    	}
       	    } 
    	 ...
    	 * @return chatMessages
    	 */    	    
    	public static FoundMessages getAllChatMessages() {
	     ...
	     * @return
	     */    	    
	    public static int getNumberAllChatMessages() {
	    	
	    	return allChatMessages.totalCount;
	    }
    	    
        /**
         * Method for getting the array with the list of messages of a global search
         * @return
         */
   		public static Message[] getListofAllChatMessages() {
   			
	    	return allChatMessages.messages;	
	    }
			
		
   		/**
   		 * Method for getting the size of the array with the list of messages of a global search
   		 * @return
   		 */
   		public static int getSizeOfListofAllChatMessages() {  	 
   			
 	    	return allChatMessages.messages.length;
 	    }
   		
 	    
    	//GET A LIST OF ALL CHATS THE USER HAS JOINED//
    	    
    	    /**
    	     * Method for getting the user chatsList
    	     * @param limit
    	     */
			public static void getMainChatList(final int limit) {
				...
				try {
					Thread.sleep(1000);  //we need to wait some time before the variable is initialized by the response handler.
			...
			/**
			 * Method for getting the iterator associated to the user chatsList
			 * @return iter
			 */	    	    
			public static java.util.Iterator<OrderedChat> getIter(){
			...
			/**
			 * Method for getting the map variable of chats
			 * @return chats
			 */
			public static ConcurrentMap<Long, TdApi.Chat> getChats(){
			...
			/**
			 * Method for getting the class variable mainChatList
			 * @return
			 */
			public static NavigableSet<OrderedChat> getChatList(){
			...
			//GET A LIST WHICH ALL PUBLIC CHATS THE USER MAY JOIN//
			
			/**
			 * Method for searching all public chats that match the query
			 ...
			 * @param query
			 */
			public static void searchPublicGroups(String query) {
				//If your code is executing in a multi-threaded environment, you need synchronization for objects, which are shared among multiple threads, to avoid any corruption of state or any kind of unexpected behavior.
	   		 	synchronized (publicChats) {  
	   		 		client.send(new TdApi.SearchPublicChats(query), defaultHandler);
	   		 	}   	    	
	   		 }
	    	 
	    	 
			/**
			 * Method for getting object with all public chats
			 * @return
			 */
	    	 public static Chats getPublicChats() {	    
	    	...
	    	/**
	    	 * Method for searching a specific chat
	    	 * @param query
	    	 */
	    	 public static void searchChat(Long query) {
	    		 //If your code is executing in a multi-threaded environment, you need synchronization for objects, which are shared among multiple threads, to avoid any corruption of state or any kind of unexpected behavior.
	    		 
	    		 synchronized (chat) {
	    		 client.send(new TdApi.GetChat(getChatId(""+query)), defaultHandler); //Add "" to convert Long to String
	    		 }
	   		 }
	    	
	    	
	    	 /**
	    	  * Method for getting object with a chat
	    	  * @return
	    	  */
			 ...
			 * @param query
			 */
			public static void joinUserToChat(String query) { 
				
	   		 	client.send(new TdApi.JoinChat(getChatId(query)), defaultHandler);	    	
	   		}
			...
			/**
			 * Method for getting the date from a specific userId
			 * @param query
			 */
			public static void getUserInfo(Long query) { 
				
   		 		client.send(new TdApi.GetUser(getChatId(""+query)), defaultHandler);   
   		 	}
    	    ...
    	    /**
    	     * Method for quitting from Telegram
    	     */
    	    ...
    	    /**
    	     * The variable control is used for informing when a reply from Telegram has been received
    	     * @return 
    	     */
    	    ...
    	    /**
    	     * Method for setting the value of variable control
    	     * @param value
    	     */
	    	 public static void setControl(boolean value) {
    	    ...
    	    public static void searchAllChatMessagesTest(String query, int limit) {
   		 	...
   		 	public static void searchChatMessagesTest(String query, long chat, int limit ) {
   		 		//If your code is executing in a multi-threaded environment, you need synchronization for objects, which are shared among multiple threads, to avoid any corruption of state or any kind of unexpected behavior.
   		 		synchronized (chatMessages) {  
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        ...
        switch (Telegram.authorizationState.getConstructor()) {
            ...
            case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
                ...
                break;
            default:
                System.err.println("Unsupported authorization state:" + newLine + Telegram.authorizationState);
        }
    }
    ...
    private static void getCommand() {
        ...
        try {
    		...
    		//Metodo original, solo se ha renombrado
		    private static void getMainChatListOriginal(final int limit) {
    	        synchronized (mainChatList) {
    ...
    //se cambia la visibilidad de la clase interna 'OrderedChat' a public  para que sea accesible desde fuera del package 
        ...
        public void onResult(TdApi.Object object) {        	            
            switch (object.getConstructor()) {
            	case TdApi.FoundMessages.CONSTRUCTOR :        		
            		allChatMessages = (FoundMessages) object;        		
            		control = true;
            	case TdApi.FoundChatMessages.CONSTRUCTOR :        		
            		chatMessages = (FoundChatMessages) object;        		
            		control = true;
            	case TdApi.Chats.CONSTRUCTOR :        		
            		publicChats = (Chats) object;        		
            		control = true;
    ...
    //static class LogMessageHandler implements Client.LogMessageHandler {
        @Override
